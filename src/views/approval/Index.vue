<template>
  <div>
      ...
      <el-table
        ...
        <el-table-column fixed="right" label="操作">
          <template slot-scope="scope">
            <el-button type="text" v-if="scope.row.applyState ==0" size="small" @click="showApproval(scope.row)">审批</el-button>
          </template>
        </el-table-column>
      </el-table>
    ...
    <el-dialog :visible.sync="detailVisible" title="审批" width="600px" class="pf-dialog-body">
      ...
      <pf-divider height="10px" type="empty"></pf-divider>
      <el-row>
        <el-col :span="3">审批意见:</el-col>
        <el-col :span="21">
          <el-input type="textarea" v-model="approvalDto.approveOpinion" maxlength="100" show-word-limit>
          </el-input>
        </el-col>
      </el-row>
      <pf-divider height="10px" type="empty"></pf-divider>
      <el-row>
        <el-col :offset="6" :span="18">
          <el-button @click="approval(20)">通过</el-button>
          <el-button @click="approval(30)">退回</el-button>
        </el-col>
      </el-row>
    </el-dialog>
  </div>
